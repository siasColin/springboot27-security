...
public class RedisConfig extends CachingConfigurerSupport {
            ...
            public Object generate(Object target, Method method, Object... params) {
                ...
                for (Object obj : params) {
                    if (obj instanceof LinkedHashMap) {
                        ...
                        Map mapKey = (HashMap) obj;
                        Set<String> set = mapKey.keySet();
                        String[] arr = set.toArray(new String[set.size()]);
                        Arrays.sort(arr, String.CASE_INSENSITIVE_ORDER);
                        Map<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
                        for (String key : arr) {
                            linkedHashMap.put(key, mapKey.get(key));
                        }
    ...
    public CacheManager cacheManager() {
        ...
        cacheNames.add("my-redis-cache3");
        // 对每个缓存空间应用不同的配置
        Map<String, RedisCacheConfiguration> configMap = new HashMap<>();
        configMap.put("my-redis-cache1", config);
        configMap.put("my-redis-cache2", config.entryTtl(Duration.ofSeconds(600)));
        configMap.put("my-redis-cache3", config.entryTtl(Duration.ofSeconds(3600)));
